...
```{r EGVskaiti, echo=FALSE, fig.cap="Sugu izplatības modeļu parametrizācijai izvēlāmo ekoģeogrāfisko mainīgo skaits, atkarībā no klātbūtnes datu skaita modeļa apmācību kopā un indikatīvās permutāciju ietekmes.", out.width = '80%'}
knitr::include_graphics("./Atteli/ch007_EGVminSkaitam.png")
```
