...
```{r EGVskaiti, echo=FALSE, fig.cap="Sugu izplatības modeļu parametrizācijai izvļāmo ekoģeogrāfisko mainīgo skaits, atkarībā no klātbūtnes datu skaita modeļa apmācību kopā un indikatīvās permutāciju ietekmes.", out.width = '80%'}
