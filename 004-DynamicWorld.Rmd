...
```{r DWq14, echo=FALSE, out.width = '100%', fig.cap='Lauksaimniecības kultūru grupas "vasaras rapsis" saistība ar DW klasēm.'}
...
```{r DWq16, echo=FALSE, out.width = '60%', fig.cap='Lauksaimniecības kultūru grupas "kukurūza" saistība ar DW klasēm.'}
