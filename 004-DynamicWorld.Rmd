...
```{r DW_q00, echo=FALSE, out.width = '100%', fig.cap='DW rezultātu pieejamība dažādos sezonālajos griezumos kopš Sentinel-2 programmas datu pieejamības. Pikseļu krāsa attēla daļās raksturo 1 km šūnās esošo klasifikācijas iztŗukumu īpatsvaru, savukārt skaitļi attēla daļās - kopējo klasifikācijas robu īpatsvaru procentos (%).'}
...
```{r DW_q11, echo=FALSE, out.width = '100%', fig.cap='Lauksaimniecības kultūru grupas "ziemāji" saistība ar DW klasēm.'}
