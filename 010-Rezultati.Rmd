...
```{r rezCOTCOT, echo=FALSE, out.width = '100%', fig.cap='Paipalas *Coturnix coturnix* dzīvotņu piemērotība (A), tās analīzē izmantotie klātbūtnes dati (B), sastopamības ekspektācija (C), aizsardzībai prioritārās vietas (D)'}
#knitr::include_graphics("./Atteli/ch010_COTCOT.png")
```
