...
### Dabas aizsardzības pārvaldes atvērtie dati {#Chapter3.1.16}

Informācija no [Dabas aizsardzības pārvaldes atvērto datu portāla]() (lejupielāde 2025-02-06; atjaunošana datēta ar 2024-12-27):

- [Aizsargājamās dzīvotnes - biotopi](https://data.gov.lv/dati/lv/dataset/aizsargajamas-dzivotnes-biotopi);

- [Īpaši aizsargājamās dabas teritorijas](https://data.gov.lv/dati/lv/dataset/ipasi-aizsargajamas-dabas-teritorijas);

- [Mikroliegumi](https://data.gov.lv/dati/lv/dataset/mikroliegumi).
...
3) papildus drošībai, pirmā soļa rezultātam atkārtota reljefa depresiju meklēšana un aizpildīšana [@WangLiu2006];
