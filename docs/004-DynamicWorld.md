...
### Q1: LAD kultūru stratificēšanai {#chapter4.2.16}
...
<p class="caption">(\#fig:DWq1klasteri)PCA rezultāti DW klašu sastopamībai sugu izplatības modelēšanai paredzētajā lauku kultūru dalījumā.</p>
</div>
...
<p class="caption">(\#fig:DWq21)DW klašu sastopamība meža nogabalos ar atšķirīgām valdošajām koku sugu grupām.</p>
</div>
...
<p class="caption">(\#fig:DWq52)Ar platību svērtā 2023. gada DW klašu sastopamība kopš 2013. gada veiktās kailcirtēs.</p>
</div>
...
<p class="caption">(\#fig:DWq6)Ar platību svērtā 2018. gada DW klašu sastopamība 2018. gadā par aramzemēm kļuvušajos ilggadīgajos zālājos.</p>
</div>
