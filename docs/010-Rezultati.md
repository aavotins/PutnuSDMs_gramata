...
pieejai. Attēlos iekļauti sekojoši raksturojumi:
  ...
  3.1. "Neatkarīgā testa TSS" (*attēla A daļā*), kas raksturo *True skill statistic* (TSS) 
  ...
  3.2. "Apmācību un validācijas TSS starpība" (*attēla A daļā*), kas raksturo TSS 
  ...
  3.3. "Validācijas TSS" (*attēla A daļā*), kas raksturo TSS vērtību telpiski nodalītā 
  ...
  3.4. "Apmācību TSS" (*attēla A daļā*), kas raksturo TSS vidējo aritmētisko vērtību 
  ...
  3.5. "Neatkarīgā testa AUC" (*attēla A daļā*), kas raksturo laukumu zem uztvērēja 
  ...
  3.6. "ROC līkne" (*attēla B daļā*), kas raksturo modeļa spēju atšķirt sugai piemērotās 
  ...
  3.7. "AUC (validācijas)" (*attēla C daļā*), kas raksturo atkārtoti pielāgotā modeļa 
  ...
  3.8. "Continuous Boyce Index (validācijas)" (*attēla C daļā*), kas raksturo modeļa 
  ...
  3.9. "10% training omission rate" (*attēla C daļā*), kas raksturo kādu īpatsvaru 
  ...
  3.10. "Minimum training omission rate" (*attēla C daļā*), pēc būtības ir līdzīgs 
...
4. tabula ar raksturojumu atsvišķiem biežāk lietotajiem projicētās dzīvotņu piemērotības izvērtējumiem, kas raksturo modeli, veicot dalījumu piemērotajās un nepiemērotajās vietās:
  ...
  4.1. rindas raksturo sekojošus sliekšņa līmeņus (projicētās dzīvotņu piemērotības vērtība, kas nošķir piemērotās no nepiemērotajām vietām):
  ...
  4.2. katram no tiem sniegts sekojošs izvērtējums:
...
7. modeļiem, kuru rezultātu ir vērts tālāk lietot, piedāvāta iespēja lejupielādēt sekojošus datu objektus:
  ...
  7.1. projicētā (cloglog) dzīvotņu piemērotība kā GeoTIFF slānis;
  
  7.2. tabula ar sliekšņa līmeņiem projicētās dzīvotņu piemērotības dalījumam 
  piemērotās un nepiemērotās (kā .xlsx fails);
  
  7.3. par labāko atzītais modelis (krosvalidāciju objekts kā *.RDS fails);
  
  7.4. par labāko atzītais modelis (kombinēts krosvalidāciju objekts kā *.RDS fails);
  
  7.5. par labāko atzītais modelis (tikai ietekmīgās pazīmes kombinētajā krosvalidāciju 
  objektā, lai atvieglotu turpmāku izplatības projicēšanu kā *.RDS fails);
  
  7.6. tabula ar ekoģeogrāfisko mainīgo izvēles gaitu, to VIF (savstarpējās 
...
9. no projicētās dzīvotņu piemērotības aprēķinātā preference: 
  ...
  9.1. ekosistēmu grupām (apbūve (t.sk. ceļi), ūdeņi, mitrāji (bez ūdeņiem), 
  lauksaimniecībā izmantojamās zemes, meži);
  
  9.2. ES aizsargājamo biotopu grupām ();
  
  9.3. *Natura 2000* tīklam;
  
  9.4. īpaši aizsargājamās dabas teritorijas funkcionālajai zonai;
...
11. sugām, kurām ierosināta individuālās aizsardzības plānošana, vietu prioritizēšanas aizsardzībai rezultāti:
  ...
  11.1. attēls ar vietu nozīmes sugas aizsardzībā rangiem, izzušanas riska un aizsargātās populācijas daļas līknēm, aizsardzībai prioritārajām vietām - tām, kurās nozīmes rangi ir kopš izzušanas un aizsargātās populācijas daļas pa labi;
  
  11.2. vietu nozīmes (rangu: [0, 1]) sugas aizsardzībā GeoTIFF slānis lejupielādei;
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_COTCOT.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCOTCOT)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_COTCOT.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCOTCOT)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PERPER.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PERPER.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPERPER)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_BONBON.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsBONBON)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_BONBON.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojBONBON)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TETURO.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsTETURO)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TETURO.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTETURO)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LYRTET.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLYRTET)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LYRTET.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLYRTET)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CYGCYG.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCYGCYG)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CYGCYG.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCYGCYG)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ANSANS.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsANSANS)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ANSANS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojANSANS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TADTAD.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsTADTAD)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TADTAD.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTADTAD)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_AYTFER.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsAYTFER)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_AYTFER.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojAYTFER)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_AYTFUL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsAYTFUL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_AYTFUL.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojAYTFUL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_SPAQUE.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsSPAQUE)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_SPAQUE.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojSPAQUE)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_SPACLY.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsSPACLY)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_SPACLY.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojSPACLY)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_MARSTR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsMARSTR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_MARSTR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojMARSTR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_MARPEN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsMARPEN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_MARPEN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojMARPEN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TACRUF.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsTACRUF)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TACRUF.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTACRUF)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsPODGRI)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PODGRI.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPODGRI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsPODCRI)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PODCRI.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPODCRI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_STRTUR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsSTRTUR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_STRTUR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojSTRTUR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CAPEUR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCAPEUR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CAPEUR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCAPEUR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_RALAQU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_RALAQU.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojRALAQU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CRECRE.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCRECRE)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CRECRE.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCRECRE)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PORPOR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsPORPOR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PORPOR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPORPOR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ZAPPAR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsZAPPAR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ZAPPAR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojZAPPAR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_FULATR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsFULATR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_FULATR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojFULATR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_GRUGRU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsGRUGRU)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojGRUGRU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CICNIG.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCICNIG)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CICNIG.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCICNIG)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CICCIC.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCICCIC)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojCICCIC)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsBOTSTE)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_BOTSTE.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojBOTSTE)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_IXOMIN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<p class="caption">(\#fig:HSprojIXOMIN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsHAEOST)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojHAEOST)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PLUAPR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsPLUAPR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PLUAPR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPLUAPR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CHAHIA.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCHAHIA)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojCHAHIA)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CHADUB.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCHADUB)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CHADUB.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCHADUB)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_VANVAN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsVANVAN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_VANVAN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojVANVAN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_NUMARQ.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsNUMARQ)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_NUMARQ.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojNUMARQ)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_GALGAL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsGALGAL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_GALGAL.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojGALGAL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TRITOT.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsTRITOT)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TRITOT.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTRITOT)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TRIGLA.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TRIGLA.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTRIGLA)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_GLAPAS.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsGLAPAS)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_GLAPAS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojGLAPAS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_AEGFUN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsAEGFUN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_AEGFUN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojAEGFUN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ASIOTU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsASIOTU)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ASIOTU.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojASIOTU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_STRALU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsSTRALU)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojSTRALU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsSTRURA)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_STRURA.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojSTRURA)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_BUBBUB.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsBUBBUB)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_BUBBUB.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojBUBBUB)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PANHAL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsPANHAL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PANHAL.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPANHAL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PERAPI.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PERAPI.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPERAPI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CLAPOM.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCLAPOM)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CLAPOM.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCLAPOM)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CIRAER.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCIRAER)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CIRAER.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCIRAER)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:HSprojACCNIS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ACCGEN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsACCGEN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ACCGEN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojACCGEN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_HALALB.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsHALALB)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_HALALB.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojHALALB)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_MILMIL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsMILMIL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_MILMIL.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojMILMIL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_MILMIG.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsMILMIG)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_MILMIG.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojMILMIG)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_BUTBUT.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsBUTBUT)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojBUTBUT)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_UPUEPO.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsUPUEPO)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_UPUEPO.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojUPUEPO)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CORGAR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCORGAR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CORGAR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCORGAR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_JYNTOR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsJYNTOR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojJYNTOR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PICCAN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsPICCAN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PICCAN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPICCAN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_DRYMAR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_DRYMAR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojDRYMAR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsPICTRI)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PICTRI.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPICTRI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LEIMED.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLEIMED)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LEIMED.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLEIMED)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_DRYMIN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsDRYMIN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_DRYMIN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojDRYMIN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_DENLEU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsDENLEU)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_DENLEU.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojDENLEU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsDENMAJ)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojDENMAJ)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_FALTIN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<p class="caption">(\#fig:HSprojFALTIN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ORIORI.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsORIORI)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojORIORI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LANCOL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLANCOL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LANCOL.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLANCOL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LANEXC.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLANEXC)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LANEXC.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLANEXC)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_NUCCAR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsNUCCAR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_NUCCAR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojNUCCAR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:HSprojPERATE)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LOPCRI.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<p class="caption">(\#fig:HSprojLOPCRI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsPOEPAL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojPOEPAL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_POEMON.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsPOEMON)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_POEMON.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPOEMON)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LULARB.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LULARB.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLULARB)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsALAARV)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ALAARV.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojALAARV)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_IDUCAL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsIDUCAL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojIDUCAL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ACRRIS.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsACRRIS)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ACRRIS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojACRRIS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ACRARU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ACRARU.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojACRARU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LOCFLU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLOCFLU)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojLOCFLU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LOCNAE.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLOCNAE)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LOCNAE.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLOCNAE)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_HIRRUS.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsHIRRUS)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_HIRRUS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojHIRRUS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:HSprojPHYSIB)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_AEGCAU.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsAEGCAU)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojAEGCAU)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CURNIS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCURNIS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CURCOM.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCURCOM)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojCURCOM)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CERFAM.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCERFAM)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CERFAM.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCERFAM)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsSITEUR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_SITEUR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojSITEUR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_STUVUL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsSTUVUL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojSTUVUL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TURVIS.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TURVIS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTURVIS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_TURILI.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_TURILI.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojTURILI)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LUSLUS.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsLUSLUS)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LUSLUS.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLUSLUS)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_FICPAR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsFICPAR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_FICPAR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojFICPAR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_FICHYP.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsFICHYP)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_FICHYP.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojFICHYP)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_SAXRUB.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsSAXRUB)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_SAXRUB.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojSAXRUB)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_REGREG.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsREGREG)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_REGREG.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojREGREG)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_REGIGN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsREGIGN)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_REGIGN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojREGIGN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PASMON.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsPASMON)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PASMON.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPASMON)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ANTPRA.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsANTPRA)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_ANTPRA.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojANTPRA)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_ANTCAM.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsANTCAM)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojANTCAM)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_MOTFLA.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsMOTFLA)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_MOTFLA.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojMOTFLA)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_MOTCIT.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsMOTCIT)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<p class="caption">(\#fig:HSprojMOTCIT)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_COCCOC.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCOCCOC)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_COCCOC.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCOCCOC)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CARERY.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<p class="caption">(\#fig:HSprojCARERY)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_PYRPYR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_PYRPYR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojPYRPYR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CHLCHL.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCHLCHL)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CHLCHL.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCHLCHL)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_LINCAN.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LINCAN.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLINCAN)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<p class="caption">(\#fig:ModelaRaksturojumsLOXCUR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_LOXCUR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojLOXCUR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_CARCAR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsCARCAR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_CARCAR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojCARCAR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_EMBHOR.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsEMBHOR)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_EMBHOR.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojEMBHOR)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_IzvelesAttels/IzvelesAttels_EMBCIT.png" alt="Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā." width="100%" />
<p class="caption">(\#fig:ModelaRaksturojumsEMBCIT)Labākā modeļa izvēle un izvērtējums: A - labākā modeļa (ar treknu melnu punktu) salīdzinājums ar citiem pielāgotajiem modeļiem (pelēkie punkti un to sastopamības blīvuma funkcijas); B - klasifikācijas spējas līknes labākā modeļa apmācību un neatkarīgās testēšanās kopās; C - labākā modeļa izvērtējums, to salīdzinot ar nejauši ģenerētiem nulles modeļiem (n=100) tajā pašā EGV, klātbūtnes un fona punktu veidotajā informācijas telpā.</p>
</div>
...
<div class="figure">
<img src="./Atteli/Beigam_KarteNebal/BeiguKarteiNebal_EMBCIT.png" alt="Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam)." width="100%" />
<p class="caption">(\#fig:HSprojEMBCIT)Dzīvotņu piemērotības projekcija. Krāsu skala reprezentē cloglog vērtību no 0 līdz 1, kur starp galapunktiem esošā atzīme ir vienādas sensitivātes un specifiskuma treniņdatos slieksnis iepriekšējā tabulā (izvēlēts vizualizēšanas mērķiem un skaidrošanas ērtumam).</p>
</div>
