...
<div class="figure">
<img src="./Atteli/ch001_AinavTelpas.png" alt="Sugu dalījums ekosistēmās un ainavas platībās (sugu kodi ar zvaigsnīti, raksturo telemetrijas pētījumu rezultātus; telemetrijas pētījumu un citiem rezultātiem ir atšķirīgi simboli)" width="100%" />
<p class="caption">(\#fig:AinavTelpas)Sugu dalījums ekosistēmās un ainavas platībās (sugu kodi ar zvaigsnīti, raksturo telemetrijas pētījumu rezultātus; telemetrijas pētījumu un citiem rezultātiem ir atšķirīgi simboli)</p>
</div>
