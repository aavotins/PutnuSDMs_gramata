...
- `Pirmas_ligzdosanas_vecums`, kurā raksturots pirmās ligzdošanass vecums (kalendārais gads). Informācija apkopota no [@KrampisVol1], [@KrampisVol2], [@KrampisVol3], [@KrampisVol4], [@KrampisVol5], [@KrampisVol6], [@KrampisVol7], [@KrampisVol8], [@KrampisVol9];
...
- `Dejumu_skaits`, kurā norādīts sugai raksturīgais dējumu skaits (sekojot prioritātēm, kas aprakstītas nodaļā [Ligzdošanas sezona](#Chapter1.3.2))
